...
abstract class AllowableValuesMinMaxValidatorProvider implements ValidatorProvider {
    ...
    final List<Validator> getValidators(Parameter parameter, @Nullable String allowableValues) {
        Long minimum = null;
        Long maximum = null;
